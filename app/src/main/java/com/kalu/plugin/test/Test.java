...
//    }
    ...
    public void onPermissionRequestMain(Activity var1, boolean isCall, boolean isPass) {
//    private void onPermissionRequestMain(Activity var1, boolean isCall, boolean isPass, boolean isFragment, int requestCode, String[] permissions) {
//
