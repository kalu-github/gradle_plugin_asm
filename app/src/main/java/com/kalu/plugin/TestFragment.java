...
//
//    @PermissionVerification(requestPermissions = {Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, requestCode = 1002, callName = "com/kalu/plugin/TestFragment", isFragment = true)
